# Freedom PDF Viewer Extension (v3.0.5)
...
1. Download the [Freedom_PDF_Viewer_v3.0.5.zip](link-to-releases) from the Releases page.
...
To package the extension for upload to the Chrome Web Store, simply run the included `build.bat` script on Windows. It will securely compress the necessary files into `Freedom_PDF_Viewer_v3.0.5.zip`, deliberately excluding development files like `.git`.
